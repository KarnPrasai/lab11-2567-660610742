...
export default function RegisterForm() {
  ...
  const userAgreeOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        <input className="me-2" type="checkbox" onChange = {userAgreeOnChange} checked = {isUserAgreed}/>I agree to the terms and
        conditions
      </div>
      ...
      <button
        ...
        disabled={!isUserAgreed ?  true : false}
      >
        Register
      </button>
    </div>
